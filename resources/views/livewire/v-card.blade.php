...
<div class="relative bg-white max-w-xs	  text-black-600 p-4 rounded-tl-3xl shadow-lg flex flex-col items-center">
    <div class="absolute top-0 right-0 bg-yellow-400 text-white text-sm font-semibold px-2 py-1 rounded-bl-lg">
        Virtual Assistant
    </div>
    ...
    <div class="flex flex-wrap justify-center space-x-2">
        <span class="bg-yellow-400 text-white text-xs font-semibold px-2 py-1 m-1 rounded-full">#Efficiency</span>
        <span class="bg-yellow-400 text-white text-xs font-semibold px-2 py-1 m-1 rounded-full">#Multitasking</span>
        <span class="bg-yellow-400 text-white text-xs font-semibold px-2 py-1 m-1 rounded-full">#Admin</span>
    </div>
</div>
